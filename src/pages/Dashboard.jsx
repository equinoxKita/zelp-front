...
import { 
  Zap, Mail, Wallet, ShoppingBag, Settings, Server, FileText, CreditCard, 
  ArrowRight, Megaphone, Info, AlertTriangle, CheckCircle2, Banknote, Package 
} from 'lucide-react';
    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 animate-in">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          {[
            { to: '/deposit', icon: Banknote, label: 'Isi Saldo', desc: 'Top up wallet', color: 'text-success', bg: 'bg-success/5' },
            ...
            { to: '/subscriptions', icon: Package, label: 'Layanan Saya', desc: 'Kelola server aktif', color: 'text-accent-secondary', bg: 'bg-accent-secondary/5' },
            ...
            const classes = "card p-5 lg:p-6 group hover-glow cursor-pointer animate-slide-up bg-gradient-to-br from-bg-card to-white/[0.02] text-left w-full";
